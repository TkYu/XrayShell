...
namespace XrayShell.Services
{
    public class MenuViewController
    {
        ...
        private readonly XrayShellController controller;
        ...
        public MenuViewController(XrayShellController controller)
        {
        ...
        private void UpdateTrayIcon()
        {
            ...
            var text = I18N.GetString("XrayShell") + " " + Global.Version + "\n" +
                       (enabled ?
        ...
        private async void CheckUpdate(Configuration config,bool noFoundNotify = false)
        {
            ...
            {
                updateflag = 3;
                ShowBalloonTip(I18N.GetString("XrayShell and XrayCore Update Found :") + $"{result.Item3}/{result.Item4}", I18N.GetString("Click here to update"), ToolTipIcon.Info, 5000);
                return;
            }
            if (result.Item1)
            {
                updateflag = 1;
                ShowBalloonTip(I18N.GetString("XrayShell Update Found :") + result.Item3, I18N.GetString("Click here to update"), ToolTipIcon.Info, 5000);
                return;
            }
            if (result.Item2)
            {
                updateflag = 2;
                ShowBalloonTip(I18N.GetString("XrayCore Update Found :") + result.Item4, I18N.GetString("Click here to update"), ToolTipIcon.Info, 5000);
                return;
            }
            if(noFoundNotify)
                ShowBalloonTip(I18N.GetString("XrayShell"), I18N.GetString("No update is available"), ToolTipIcon.Info, 5000);
        }
        ...
        void controller_UpdatePACFromGFWListCompleted(object sender, GFWListUpdater.ResultEventArgs e)
        {
            ...
            ShowBalloonTip(I18N.GetString("XrayShell"), result);
        }
        ...
        {
            MessageBox.Show(e.GetException().ToString(), I18N.GetString("XrayShell Error:") + e.GetException().Message);
        }
        ...
        void controller_FileReadyToOpen(object sender, XrayShellController.PathEventArgs e)
        {
        ...
        private void notifyIcon1_Click(object sender, MouseEventArgs e)
        {
            ...
            {
                ShowLogForm(Xray.AccessLogPath);
            }
        }
        ...
        {
            System.Diagnostics.Process.Start("https://github.com/TkYu/XrayShell");
        }
                                                ...
                                                screen.Bounds.Height))
                {
                    ...
                    for (int i = 0; i < maxTry; i++)
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            {
                                var proto = result.Text.Substring(0, result.Text.IndexOf("://", StringComparison.Ordinal)).ToLower();
                                if (proto == "vless" || proto == "vmess" || proto == "trojan-go" || proto == "trojan" || proto == "ss")
                                {
        ...
        {
            _notifyIcon.BalloonTipTitle = I18N.GetString("XrayShell is here");
            _notifyIcon.BalloonTipText = I18N.GetString("You can turn on/off XrayShell in the context menu");
