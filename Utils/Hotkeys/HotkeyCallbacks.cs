...
namespace XrayShell.Hotkeys
{
    public class HotkeyCallbacks
    {

        public static void InitInstance(XrayShellController controller,MenuViewController menu)
        {
            if (Instance != null)
            {
                return;
        ...
        private HotkeyCallbacks(XrayShellController controller,MenuViewController menu)
        {
